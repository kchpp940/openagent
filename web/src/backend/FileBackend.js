...
export function refreshFileVectorsIncremental(file) {
  const newFile = Setting.deepCopy(file);
  return fetch(`${Setting.ServerUrl}/api/refresh-file-vectors-incremental`, {
    method: "POST",
    credentials: "include",
    headers: {
      "Accept-Language": Setting.getAcceptLanguage(),
...
export function getFileVersionDiffs(owner, name) {
  return fetch(`${Setting.ServerUrl}/api/get-file-version-diffs?id=${owner}/${encodeURIComponent(name)}`, {
    method: "GET",
    credentials: "include",
    headers: {
      "Accept-Language": Setting.getAcceptLanguage(),
...
export function getLatestFileVersionDiff(owner, name) {
  return fetch(`${Setting.ServerUrl}/api/get-latest-file-version-diff?id=${owner}/${encodeURIComponent(name)}`, {
    method: "GET",
    credentials: "include",
    headers: {
      "Accept-Language": Setting.getAcceptLanguage(),
...
export function getFileParseVersions(owner, name) {
  return fetch(`${Setting.ServerUrl}/api/get-file-parse-versions?id=${owner}/${encodeURIComponent(name)}`, {
    method: "GET",
    credentials: "include",
    headers: {
      "Accept-Language": Setting.getAcceptLanguage(),
